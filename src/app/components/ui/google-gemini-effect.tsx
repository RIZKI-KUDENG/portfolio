...
export const GoogleGeminiEffect = ({
 ...
 className={cn("sticky top-80", className)}>
      ...
      <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
        {description ||
          `I'm Still Learning! More Skills will be added in the future.`}
      </p>

      <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
        <button className="font-bold bg-white rounded-full md:px-4 md:py-3 px-4 py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto ">
          Technology
        </button>
      </div>
      ...
      <svg
        ...
        className=" absolute -top-60  md:-top-40 w-full max-sm:px-5 max-md:px-5 max-lg:px-17 max-xl:px-8 max-2xl:px-5"
      >
        <motion.path
