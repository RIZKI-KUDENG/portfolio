      ...
      >
        ...
        >
          ...
          <div className="p-2 grid grid-cols-1 md:grid-cols-2 gap-4 ">
            ...
            >
              <h2 className="mb-4 text-2xl font-bold">Movie App BE</h2>
              <p className="">
            ...
            <LiquidGlass
              ...
              className="max-w-md rounded-xl p-6 hover:scale-110 transition duration-300 ease-in-out"
            >
              <h2 className="mb-4 text-2xl font-bold">Loker Sukabumi Asik</h2>
              <p className="">
            ...
            <LiquidGlass
              ...
              className="max-w-md rounded-xl p-6 hover:scale-110 transition duration-300 ease-in-out"
            >
              <h2 className="mb-4 text-2xl font-bold">Movie App FE</h2>
              <p className="">
            ...
            <LiquidGlass
              ...
              className="max-w-md rounded-xl p-6 hover:scale-110 transition duration-300 ease-in-out"
            >
              <h2 className="mb-4 text-2xl font-bold">More Projects Coming Soon</h2>
              <p className="">
